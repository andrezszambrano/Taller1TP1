...
//Se inicia una nueva partida sí controlador->partidaEnJuego = false y sí hay una palabra que no se
//ha jugado. En caso exitoso se retorna el largo de la palabra a jugar. En caso de que no haya palabra 
//(se leyó todo el archivo) se retorna -2
